...
assert.equal(output.errorCount, 0, `Should be 0 errors but there were ${output.errorCount}`);

assert.equal(output.warningCount, 0, `Should be 0 warnings but there were ${output.warningCount}`);
